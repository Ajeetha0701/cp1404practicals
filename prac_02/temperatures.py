...
Define a function fahrenheit_to_celsius(Fahrenheit):
Get user input for temperature in Celsius and Fahrenheit.
Convert the temperature in Celsius to Fahrenheit using the celsius_to_fahrenheit() function.
Print the result.
Convert the temperature in Fahrenheit to Celsius using the fahrenheit_to_celsius() function.
Print the result.
End.
"""
# CODE:
